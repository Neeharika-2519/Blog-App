...
export default function PostPage() {
  ...
  return (
    <main className='p-3 flex flex-col max-w-6cl mx-auto min-h-screen'>
      ...
      <img src={post && post.image} alt={post.title} className='mt-10 p-3 max-h-[500px] w-full object-cover post-image' />  
